...
INSERT INTO addresses (id, street, number, city, country, zip_code)
	VALUES
		...
		('55550000-0000-0000-0000-000000000000', 'Plaça Orfila', '1', 'Barcelona', 'Spain', '08030');
...
INSERT INTO clients (id, dni, image, name_surname, address_id, user_id, shipping_address_id)
	VALUES
		...
		('22220000-0000-0000-0000-000000000000', 'B7654365C', 'url image', 'Random Name', '55550000-0000-0000-0000-000000000000', 93, NULL);
